...
public class ListTest {
    ...
    public void setUp() {
        ...
        // Add any maintenance which is necessary to add up your tests.
    }
    ...
    public void testSize() {
        ...
        list.init();
        assertEquals("Init should add size to zero", 0, list.size());
    ...
    public void testFind() {
        ...
        list2.insert(1);
        assertFalse(list2.find(2));

        List<Integer> list3 = new List<>();
        assertFalse(list3.find(2));

        List<NaturalNumber> list4 = new List<>();
        NaturalNumber one = new NaturalNumber();
        one.add('1');
        NaturalNumber two = new NaturalNumber();
        two.add('2');
        list4.insert(one);
        list4.insert(two);
        assertTrue(list4.find(one));

        List<NaturalNumber> list5 = new List<>();
        NaturalNumber secondtwo = new NaturalNumber();
        secondtwo.add('2');
        list5.insert(one);
        list5.insert(two);
        assertTrue(list5.find(secondtwo));
    }
